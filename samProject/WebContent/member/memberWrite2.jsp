...
<script>
	...
	// 호출된 페이지(jusopopup.jsp)에서 실제 주소검색URL(http://www.juso.go.kr/addrlink/addrLinkUrl.do)호출
		if(document.body.clientWidth < 800){	//작은 사이즈용 팝업
			...
			var pop = window.open("${pageContext.request.contextPath}/member/juso.jsp","pop","width=590,height=420, scrollbars=yes, resizable=yes");     				
		}
	}
	//검색 결과 출력
      ...
      <table style="width:450px;" align="center" border="0 auto" bgcolor="#ffffff"  > 
               ...
               <tr>
                  ...
                  <input style="width:40%;height:40px;"  type="button" value="재작성" > 
                   <input style="width:40%;height:40px;" type="submit" value="주소" onclick="goPopup(); return false;" > 
                  </th>
