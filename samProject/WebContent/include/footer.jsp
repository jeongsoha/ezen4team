        ...
        <div class="container">
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img style="margin-left:-150px;width:100px;height:100px;" src="../images/logo3.JPG" onclick="location='../main/home.jsp'">
              </a>
